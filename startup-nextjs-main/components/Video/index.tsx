...
const Video = () => {
  ...
  <div className='flex justify-center mb-8'>
    <blockquote 
      ...
      style={{background: '#FFF',  border: '0', borderRadius: '3px', boxShadow: '0 0 1px 0 rgba(0,0,0,0.5) 0 1px 10px 0 rgba(0,0,0,0.15)', margin: '1px',  maxWidth: '540px', minWidth: '326px', padding: '0', width:'99.375% -webkit-calc(100% - 2px) calc(100% - 2px)'}}
    >
      <div style={{padding: "16px"}}> 
        <a 
          href="https://www.instagram.com/reel/C4ifggdIOND/?utm_source=ig_embed&amp;utm_campaign=loading" 
      ...
      <p style={{color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: '0', marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap'}}>
        <a 
          ...
          rel="noreferrer"
        >
          A post shared by AUB OUTDOORS (@auboutdoors)
        </a>
      </p>
     </div>
    </blockquote> 
